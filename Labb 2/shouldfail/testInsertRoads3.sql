...
-- TEST Insert a road, when the person is not in the same area as the start or end point.

INSERT INTO Roads VALUES ('Sweden', 'Hjo', 'Sweden', 'Stockholm', 'Sweden', '19990807-1337', getval('roadtax'));
